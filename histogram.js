function verticalHistogram(data, league, variable, totalGoals, leagues, allTeamsStats, allGoals, maxGoals, minGoals, LeagueAvgAge, LeaguePasses, LeagueFouls, LaLigaBin, PremierLeagueBin, Ligue1Bin, BundesligaBin, SerieABin){
...
function horizontalHistogram(data, league, variable, totalGoals, leagues, allTeamsStats, allGoals, maxGoals, minGoals, LeagueAvgAge, LeaguePasses, LeagueFouls, LaLigaBin, PremierLeagueBin, Ligue1Bin, BundesligaBin, SerieABin){
    if(league == 'ALL LEAGUES'){
        const svgWidth = 1200;
        const svgHeight = 665;
